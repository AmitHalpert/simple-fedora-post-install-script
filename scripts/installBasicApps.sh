...
while true; do
    ...
    [Yy]*) 
        ...
        ###
        sudo dnf install gnome-extensions-app clang gnome-tweaks neofetch gnome-shell-extension-dash-to-dock gnome-tweaks htop mpv telegram-desktop virt-manager yt-dlp vim code steam discord npm java-11-openjdk-devel.x86_64 -y
